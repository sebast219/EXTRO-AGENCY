...
export default function PricingExplanation() {
  ...
  return (
    <section id="pricing-explanation" ref={ref} className="py-32 px-6 max-w-5xl mx-auto scroll-mt-20 bg-surface/30 -mx-6 px-12 sm:px-16 lg:px-24">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {t.pricingExplanation.items.map((item, i) => (
          ...
          >
            ...
            <p className="text-xs opacity-45 leading-relaxed">{item.desc}</p>
          </div>
        ))}
      </div>
    </section>
